import { Component, ViewChild, ElementRef, Input, AfterContentInit, AfterViewInit, OnDestroy, OnInit } from '@angular/core';
...
@Component({
  selector: 'app-glide-product',
  templateUrl: './glide-product.component.html',
  styleUrls: ['./glide-product.component.scss']
})
export class GlideProductComponent implements  OnInit, OnDestroy{
